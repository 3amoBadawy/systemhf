                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <textarea name="description_ar" 
                                  ...
                                  placeholder="أدخل وصف المنتج باللغة العربية">{{ old('description_ar') }}</textarea>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('profit_percentage', $defaultProfitPercent) }}"
                                   step="0.01"
                                   min="0"
...
window.addComponentRow = function() {
    ...
    if (typeof addComponentRow === 'function') {
        addComponentRow();
    }
};
...
window.removeComponentRow = function(componentId) {
    // سيتم استدعاؤها من HTML
    if (typeof removeComponentRow === 'function') {
        removeComponentRow(componentId);
    }
};

window.toggleComponentPricingRow = function(componentId) {
    // سيتم استدعاؤها من HTML
    if (typeof toggleComponentPricingRow === 'function') {
        toggleComponentPricingRow(componentId);
    }
};
</script>
@endpush
