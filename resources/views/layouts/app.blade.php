...
<head>
    ...
    <script>
        window.appCurrencySymbol = @json(isset($currencySymbol) ? $currencySymbol : (optional(\App\Models\BusinessSetting::getInstance())->currency_symbol ?? ''));
        window.appName = @json(isset($businessName) ? $businessName : (config('app.name') ?: ''));
    </script>
