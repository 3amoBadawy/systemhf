...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Contracts\CustomerRepositoryInterface' => \App\Repositories\CustomerRepository::class,
    ...
    override(\config(), map([
            ...
            'auth.throttle.max_attempts' => 'string',
            ...
            'filesystems.links./var/www/systemhf/public/storage' => 'string',
            'filesystems.max_file_size' => 'integer',
...
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','auth.throttle.max_attempts','cache.default',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/systemhf/public/storage',
'filesystems.max_file_size','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'dashboard','customers.index','customers.create','customers.store','customers.show',
'customers.edit','customers.update','customers.destroy','customers.search','customers.quick-search',
'customers.ajax-search','customers.invoices','countries.search','products.index','products.create',
'products.store','products.show','products.edit','products.update','products.destroy',
'products.search','products.byCategory','products.remove-gallery-image','products.remove-video','invoices.index',
'invoices.create','invoices.store','invoices.show','invoices.edit','invoices.update',
'invoices.destroy','invoices.search','invoices.print','payments.index','payments.create',
'payments.store','payments.show','payments.edit','payments.update','payments.destroy',
'payments.search','payments.invoice-info','payments.stats','payment-methods.index','payment-methods.create',
'payment-methods.store','payment-methods.show','payment-methods.edit','payment-methods.update','payment-methods.destroy',
'payment-methods.toggle-status','payment-methods.account','payment-methods.create-account','suppliers.index','suppliers.create',
'suppliers.store','suppliers.show','suppliers.edit','suppliers.update','suppliers.destroy',
'suppliers.toggle-status','branches.index','branches.create','branches.store','branches.show',
'branches.edit','branches.update','branches.destroy','branches.toggle-status','branches.stats',
'accounts.index','accounts.create','accounts.store','accounts.show','accounts.edit',
'accounts.update','accounts.destroy','accounts.toggle-status','accounts.update-balance','accounts.transactions-by-branch',
'accounts.all-transactions','accounts.report','financial.index','financial.store-account','financial.store-payment-method',
'financial.toggle-account-status','financial.toggle-payment-method-status','financial.destroy-account','financial.destroy-payment-method','financial.update-account-balance',
'financial.create-linked-account','financial.branch-stats','expenses.index','expenses.create','expenses.store',
'expenses.show','expenses.edit','expenses.update','expenses.destroy','expenses.approve',
'expenses.unapprove','expenses.report','system.status','system.diagnostics','system.maintenance',
'system.logs.latest','employees.index','employees.create','employees.store','employees.show',
'employees.edit','employees.update','employees.destroy','employees.search','employees.toggle-status',
'employees.report','attendance.index','attendance.report','attendance.export','attendance.check-in',
'attendance.check-out','attendance.start-break','attendance.end-break','attendance.kiosk','roles.index',
...
'permissions.edit','permissions.update','permissions.destroy','shifts.index','shifts.create',
'shifts.store','shifts.show','shifts.edit','shifts.update','shifts.destroy',
'shifts.assign-employees','shifts.update-employee-assignment','salary.index','salary.create','salary.store',
'salary.show','salary.edit','salary.update','salary.destroy','salary.report',
'salary.export','salary.generate','salary.review','salary.approve','salary.pay',
'salary.export-to-bank','categories.index','categories.create','categories.store','categories.show',
'categories.edit','categories.update','categories.destroy','categories.search','categories.toggle-status',
'system-settings.index','system-settings.update','system-settings.update-business','system-settings.remove-logo','system-settings.reset',
'system-settings.export','system-settings.import','system-settings.advanced','system-settings.clear-cache','system-settings.category',
'system-settings.update-single','system-settings.search','system-settings.restart-queue','system-settings.restart-cache','system-settings.restart-config',
'system-settings.toggle-maintenance','system-settings.optimize-database','system-settings.clear-logs','system-settings.metrics','system-settings.activity-logs',
'system-settings.export-logs','media.index','media.gallery','media.store','media.bulk-upload',
'media.show','media.update','media.destroy','media.reorder','media.optimize-images',
'media.download-from-url','api.media.list','api.media.store','api.media.bulk-upload','api.media.show',
'api.media.update','api.media.destroy','api.media.reorder','api.media.optimize-images','api.media.download-from-url','storage.local',);
        registerArgumentsSet('views', 
'accounts.all-transactions','accounts.create','accounts.edit','accounts.index','accounts.show',
'accounts.transactions-by-branch','attendance.index','attendance.kiosk','attendance.report','auth.login',
'branches.create','branches.edit','branches.index','branches.show','business-settings.index',
'categories.create','categories.edit','categories.index','categories.show','components.footer',
'components.product-gallery','customers.create','customers.edit','customers.index','customers.show',
'dashboard','dashboard.index','employees.create','employees.edit','employees.index',
'employees.show','errors.database','errors.model','expenses.create','expenses.edit',
'expenses.index','expenses.report','expenses.show','financial.index','invoices.create',
'invoices.edit','invoices.index','invoices.print','invoices.show','layouts.app',
'media.gallery','media.index','payment-methods.create','payment-methods.edit','payment-methods.index',
'payment-methods.show','payments.create','payments.index','permissions.create','permissions.edit',
'permissions.index','products.create','products.create_backup','products.create_new','products.create_old',
'products.edit','products.index','products.show','roles.create','roles.edit',
'roles.index','roles.show','salaries.index','salaries.report','salary.index',
'shifts.index','suppliers.create','suppliers.edit','suppliers.index','suppliers.show',
'system-settings.advanced','system-settings.index','system.status','welcome','laravel-exceptions-renderer::components.card',
